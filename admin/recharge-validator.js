...
class RechargeValidator {
    ...
    validateEntries(entries) {
        ...
        console.log('👥 Unique gameIds in recharges:', Object.keys(rechargesByGameId).length);
        ...
        console.log('👥 Unique gameIds in entries:', Object.keys(entriesByGameId).length);
        console.log('🔗 GameIds with both entries AND recharges:', Object.keys(entriesByGameId).filter(gid => rechargesByGameId[gid]).length);
